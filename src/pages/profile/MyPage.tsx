    ...
    return (
        ...
        <div className="sticky top-0 z-20 pt-2 mb-4">
            ...
            <button
                type="button"
                onClick={() => navigate(-1)}
                className="p-2 text-[#F6F6F6] rounded-full hover:bg-white/10"
                aria-label="뒤로가기"
            >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-auto">
            ...
            <div className="pt-6 grid grid-cols-12 gap-6">
                ...
                <div className="space-y-6">
                    {/* 프로필 카드 */}
                    <div className="rounded-2xl border border-[#2d2d2d] bg-[#2d2d2d]/80 p-6">
                    ...
                    "
                    >
                    <div className="rounded-2xl bg-[#2d2d2d]/80 p-6">
                        ...
                        <div className="rounded-2xl bg-[#4b4b4b] border border-[#2d2d2d] p-4">
                        ...
                        <div className="mt-5 rounded-2xl bg-[#4b4b4b] border border-[#2d2d2d] p-4 text-center">
                        <div className="text-sm text-[#999999]">
                ...
                {/* 우측 */}
                <aside className="col-span-6 rounded-2xl border border-[#2d2d2d] bg-[#2d2d2d]/80">
                ...
                <div className="divide-y divide-[#464646]">
                    ...
                    >
                        ...
                        <div className="pl-4 min-w-0">
                            ...
                            <div className="h-12 w-12 shrink-0 rounded-2xl bg-[#777777]" />
                            <div className="min-w-0">
