    ...
    return (
        ...
        <div className="px-8 pt-6 pb-2 flex items-center justify-between">
            ...
            className="
                ...
                hover:bg-[#f6f6f6]/10 hover:text-[#f6f6f6]/80
                transition-all
            "
            >
            <FaPlus size={16} />
        ...
        <div className="px-6 pb-6 overflow-x-auto">
            ...
            <div className={gridClass}>
                ...
                >
                    ...
                    <div className="text-sm font-semibold text-white/95 truncate group-hover:text-[#AFDEE2] transition-colors">
                        {it.title}
                    </div>
                    </div>
                </button>
                ...
                {items.length === 0 && (
                <div className="col-span-full py-10 text-sm text-white/60 text-center">
