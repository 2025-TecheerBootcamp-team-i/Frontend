...
type ChartRow = { id: string; rank: number; title: string; diff: number; artist: string; duration: string };
...
const chart: ChartRow[] = Array.from({ length: 10 }).map((_, i) => ({
    id: String(i + 1),
    rank: i + 1,
    title: "곡 명",
    artist: "아티스트명",
    diff: i === 0 ? 0 : Math.floor(Math.random() * 5) - 2, // -2 ~ +2,
    duration: "곡 길이",
}));
...
function HomePage() {
    ...
    const tabBtn = (key: "TOP100" | "DAILY" | "AI", label: string) => {
        ...
        return (
            <button
                ...
                active ? "bg-[#666666] text-white" : "bg-[#EAEAEA] text-[#666666] hover:bg-[#DCDCDC]",
                ].join(" ")}
            >
                {label}
            </button>
    ...
    const previewRows = chart.slice(0, 6);
    ...
    return (
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
            ...
            <section className="mb-6">
                ...
                <div ref={scrollRef} className="flex gap-6 overflow-x-auto px-2 py-2 no-scrollbar">
                    {artists.map((a) => (
                ...
                <div className="overflow-x-auto">
                    ...
                    <div className="sm:flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                            <button 
                                ...
                                title="전체 차트"
                                className="px-3 text-xl font-semibold text-[#666666] whitespace-nowrap">실시간 차트</button>
                    ...
                    <div className="divide-y divide-[#D9D9D9] overflow-hidden">
                        ...
                        >
                            ...
                            <div className="text-right pr-6 text-sm text-[#666666] whitespace-nowrap">{row.duration}</div>
                        </button>
                        ))}
                        
                    </div>
                    <div className="
                        flex justify-center border-t p-4 text-[#D9D9D9]
                    "><button className="hover:text-[#aaaaaa]">더보기</button></div>
