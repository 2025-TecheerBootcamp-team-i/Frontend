        ...
        return (
            <button
                ...
                className={[
                    ...
                    active
                        ? "bg-[#E4524D] text-white shadow-[0_0_15px_rgba(228,82,77,0.6)] font-bold scale-105 z-10"
                        : "bg-[#4d4d4d] text-[#F6F6F6] hover:bg-[#5d5d5d] hover:scale-105",
                ].join(" ")}
            >
                {label}
            </button>
        ...
        <>
            ...
            <section className="mb-2">
                <div className="relative">
                    <div
                        ref={scrollRef}
                        className="flex justify-between w-full px-12 py-6"
                    >
                        ...
                        "
                                ...
                                <div className="mt-4 w-[220px] text-center text-xl font-bold text-[#F6F6F6]/90 break-words leading-tight transition group-hover:text-[#f6f6f6]/60">{a.artist_name}</div>
            ...
            {/* 차트 요약 - 투명 유리 박스 스타일 적용 (Full Width with Margins) */}
            <section className="mb-4 px-12">
                <div className="w-full rounded-[40px] bg-white/[0.05] backdrop-blur-2xl border border-white/10 p-8 pb-4 shadow-[0_30px_80px_rgba(0,0,0,0.5)]">
                    <div className="overflow-x-auto">
                            ...
                            <div className="flex items-center pt-2 justify-between mb-3">
                                <div className="flex items-end gap-3">
                                    <button
                                        type="button"
                                        onClick={goChart}
                                        className="px-3 text-6xl font-bold hover:text-[#f6f6f6]/50 text-[#f6f6f6] transition whitespace-nowrap"
                                    >
                                        차트
                                    </button>
                        ...
                        "
                                    >
                                        ...
                                        <div className="ml-5 flex items-center gap-6 min-w-0 truncate">
                                            {row.albumImage ? (
                                                <img
                                                    src={row.albumImage}
                                                    alt={row.albumName}
                                                    className="w-16 h-16 rounded-xl object-cover bg-[#D9D9D9] shrink-0 shadow-lg"
                                                    loading="lazy"
                                                    decoding="async"
                                                    fetchPriority="low"
                                                    onError={(e) => {
                                            ...
                                            <div className={`w-16 h-16 rounded-xl bg-[#D9D9D9] shrink-0 ${row.albumImage ? 'hidden' : ''}`} />
                                            <div className="text-lg font-medium text-[#F6F6F6] whitespace-nowrap truncate tracking-tight">
                                                {row.musicName}
                                                {row.isAi && (
                                        ...
                                        <div className="hidden sm:block text-base text-[#F6F6F6]/80 whitespace-nowrap font-medium">
                                            {row.artistName}
                                        </div>

                                        <div className="text-right pr-6 text-base text-[#F6F6F6]/60 whitespace-nowrap font-mono">
            ...
            {/* 인기 공개 플레이리스트 (투명 유리 박스 스타일 - Match Chart Style) */}
            <section className="mb-6 px-12">
                <div className="w-full rounded-[40px] bg-white/[0.05] backdrop-blur-2xl border border-white/10 p-8 pb-4 shadow-[0_30px_80px_rgba(0,0,0,0.5)]">
                    {/* 헤더 */}
                    <div className="flex items-center justify-between mb-3">
                        <div
                            className="px-3 pt-2 text-3xl font-semibold text-[#f6f6f6] whitespace-nowrap transition"
                        >
                            인기 공개 플레이리스트
                        </div>
                    </div>
