...
type Playlist = {
    id: string;
    title: string;
    coverUrl?: string; // 나중에 실제 이미지 경로
};

function Sidebar() {
    const navigate = useNavigate();

    const [myPlaylists] = useState<Playlist[]>([
        { id: "p1", title: "운동할 때", coverUrl: "" },
        { id: "p2", title: "새벽 감성", coverUrl: "" },
        { id: "p3", title: "출근 BGM", coverUrl: "" },
    ]);
    ...
    const [myAiSongs, setMyAiSongs] = useState<AiSong[]>([
        {
            ...
            prompt: "새벽 감성 신스웨이브, 드라이브 느낌",
            createdAt: "01/09",
        },
        {
            id: "2",
            title: "Coffee Rain",
            prompt: "카페에서 듣는 로파이, 빗소리",
            createdAt: "01/08",
        },
        {
            id: "3",
            title: "AI Pop Demo",
            prompt: "밝은 K-pop 느낌, 후렴 중독적",
            createdAt: "01/06",
        },
    ]);
